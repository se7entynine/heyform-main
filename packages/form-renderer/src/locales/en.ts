export default {
  ...
  reportMeta_zero: 'No submissions yet',
  reportMeta_one: '{{count}} submission',
  reportMeta_other: '{{count}} submissions',
  reportSubmission_zero: 'No submissions yet',
  reportSubmission_one: '{{count}} submission',
  reportSubmission_other: '{{count}} submissions',
  reportSubmission2_zero: 'No submissions yet · {{average}} average',
  reportSubmission2_one: '{{count}} submission · {{average}} average',
  reportSubmission2_other: '{{count}} submissions · {{average}} average',
  paginationTitle: 'Page {{page}} to {{maxPage}}',
